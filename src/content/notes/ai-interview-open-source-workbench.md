---
slug: ai-interview-open-source-workbench
order: 2
date: 2026
image: /assets/notes/ai-interview-cover.png
title_zh: AI Interview：AI 招聘工作台
summary_zh: 一个开源智能招聘管理系统，把岗位、简历、AI 初筛、部门评审、面试、笔试、Offer、数据和自动化工作流放进同一个产品。
title_en: AI Interview: AI recruiting workbench
summary_en: An open-source AI recruiting system that connects jobs, resumes, screening, interviews, tests, offers, analytics, and workflows.
---

<!-- zh -->

![AI Interview](/assets/notes/ai-interview-cover.png)

招聘系统最难的地方，往往不是做一个候选人表单，而是把所有分散的信息重新连起来：岗位需求在文档里，简历在邮箱里，面试评价在聊天记录里，笔试链接在另一个平台，Offer 又回到邮件线程。每一步都有人参与，每一步又都可能丢上下文。

项目地址：[https://github.com/kinrochen/ai-interview](https://github.com/kinrochen/ai-interview)
...
![简历管理](/assets/notes/ai-interview-resumes.png)
...
![简历详情](/assets/notes/ai-interview-detail.png)
...
![面试评分](/assets/notes/ai-interview-scoring.png)
...
![面试分析](/assets/notes/ai-interview-analysis.png)
...
![工作流](/assets/notes/ai-interview-workflow.png)
...
```bash
git clone https://github.com/kinrochen/ai-interview.git
cd ai-interview
cp .env.example .env
...
- GitHub 仓库：[https://github.com/kinrochen/ai-interview](https://github.com/kinrochen/ai-interview)

<!-- en -->

> This article is currently published in Chinese. Switch back to Chinese to read the full original version.

## AI Interview: an open-source AI recruiting workbench

AI Interview is an open-source intelligent recruiting management system. It connects jobs, resumes, AI screening, department review, interviews, tests, offers, analytics, and visual workflows into one product.

GitHub: [https://github.com/kinrochen/ai-interview](https://github.com/kinrochen/ai-interview)
